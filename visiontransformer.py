...
class Attention(nn.Module):
    ...
    '''
    def __init__(self, embed_dim, heads=8, activation=nn.ReLU(), dropout=0.1):
    ...
    def forward(self, inp):
        ...
        query = self.activation1(self.query(inp))
        key   = self.activation1(self.key(inp))
        value = self.activation1(self.value(inp))
...
class FeedForward(nn.Module):
    ...
    Examples:
        ...
        >>> out = FF(inp)
    '''
    def __init__(self, embed_dim, activation = nn.GELU(), forward_expansion=1, dropout=0.1):
    ...
    def forward(self, inp):
        ...
        out = self.dropout(self.activation1(self.fc1(inp)))
...
class TransformerBlock(nn.Module):
    ...
    Examples:
        ...
        >>> out = TB(inp)
    '''
    def __init__(self, embed_dim, heads=8, activation=nn.ReLU(), forward_expansion=1, dropout=0.1):
        super(TransformerBlock, self).__init__()
        self.embed_dim = embed_dim
        self.norm1 = nn.LayerNorm(embed_dim)
        self.attention = Attention(embed_dim, heads, activation, dropout)
        self.norm2 = nn.LayerNorm(embed_dim)
        self.feed_forward = FeedForward(embed_dim, activation, forward_expansion, dropout)
...
class Transformer(nn.Module):
    ...
    Examples:
        ...
        >>> out = transformer(inp)
    '''
    def __init__(self, embed_dim, layers, heads=8, activation=nn.ReLU(), forward_expansion=1, dropout=0.1):
